...
class TestUploadExcel:
    ...
    def test_upload_valid_excel_file(self, test_client):
        ...
        try:
            ...
            # Harus redirect ke halaman upload dengan pesan sukses
            assert response.status_code == 302, "Upload berhasil harus redirect"
    ...
    def test_upload_empty_excel_file(self, test_client):
        ...
        try:
            ...
            assert response.status_code == 302, "Upload file kosong harus redirect dengan error"
            response = test_client.get('/upload', follow_redirects=True)
            soup = BeautifulSoup(response.data, 'html.parser')
            error_text = soup.get_text().lower()
            assert 'valid' in error_text or 'kosong' in error_text or 'tidak berisi' in error_text, \
                "Harus menampilkan error untuk file Excel kosong"
    ...
    def test_upload_duplicate_data(self, test_client):
        ...
        try:
            ...
            assert response.status_code == 302, "Upload pertama harus berhasil"
    ...
    def test_upload_success_message(self, test_client):
        ...
        try:
            ...
            assert 'berhasil' in success_text or 'success' in success_text, \
                "Harus menampilkan pesan sukses setelah upload berhasil"
