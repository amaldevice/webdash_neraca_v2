        ...
        for filename, content, mimetype in invalid_files:
            ...
            if response.status_code == 302:
                ...
                with test_client.session_transaction() as sess:
                    ...
                    if flashed_messages:
                        error_found = any("excel" in msg[1].lower() for msg in flashed_messages)
                        assert error_found, f"Expected Excel error for {filename}, got: {flashed_messages}"
                    else:
                        assert "excel" in response_text or "error" in response_text or "tidak valid" in response_text
            else:
        ...
        for field_name, field_value, expected_error in test_cases:
                ...
                with test_client.session_transaction() as sess:
                    ...
                    if flashed_messages:
                        ...
                        assert expected_error.lower() in response_text or "wajib" in response_text or "error" in response_text
        ...
        for invalid_type in invalid_data_types:
            ...
            with test_client.session_transaction() as sess:
                ...
                if flashed_messages:
                    ...
                    assert "tipe data" in response_text or "invalid" in response_text or "error" in response_text
            ...
            with test_client as client:
                ...
                with client.session_transaction() as sess:
                    ...
                    if flashed_messages:
                        ...
                        assert "periode" in response_text or "invalid" in response_text or "error" in response_text
            ...
            with test_client as client:
                ...
                with client.session_transaction() as sess:
                    ...
                    if flashed_messages:
                        ...
                        assert 'error' in response_text or 'excel' in response_text or 'tidak valid' in response_text
