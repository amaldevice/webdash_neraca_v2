...
- **2026-05-06 — Epic #47 (issues #48–#51):** Default pytest SQLite vs `.env`, perbaikan periode triwulanan tahun polos, tes kolom Nilai lewat header, sinkron `docs/codebase/TESTING.md` + README integrasi + `USE_ENV_DATABASE_URL_FOR_TESTS` untuk smoke dialek; regresi `tests/test_suite_database_defaults.py` (PR #52).
