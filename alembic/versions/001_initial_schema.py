...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("uploader_name", sa.String(191), nullable=False),
        sa.Column("version", sa.String(191), nullable=False),
        sa.Column("template_type", sa.String(191), nullable=True),
        sa.Column("data_type", sa.String(64), nullable=True),
        sa.Column("time_period", sa.String(32), nullable=True),
        sa.Column("indicator_name", sa.String(191), nullable=False),
